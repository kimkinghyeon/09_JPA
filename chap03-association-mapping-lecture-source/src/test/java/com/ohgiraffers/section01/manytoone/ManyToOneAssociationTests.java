...
public class ManyToOneAssociationTests {
    ...
    */
    ...
    public void manyToOneAssociationTest() {
        ...
        //when
        // 조회시 조인 구문이 실행되며 연관 테이블을 함께 조회한다.
    ...
    @Test
    @DisplayName("다대일 연관관계 객체지향 쿼리(JPQL) 사용한 카테고리 이름 조회 테스트")
    public void test2() {
        //given
    ...
    /*
    commit() 을 할 경우에는 컨텍스트 내에 저장된 영속성 객체를 insert 하는 쿼리문이
    작성된다. , 단 카테고리는 컨텍스트 내에 존재하지 않기 때문에
    카테고리 코드를 참조하는 tbl_menu 에 대이터를 넣을 수 없게 된다.
    이때, 사용할 수 있는것이
    ...
    * */
    ...
    public void test3() {
        ...
        menuAndCategory.setMenuName("청어까스까나리올리");
        ...
        System.out.println("foundMenuAndCategory = " + foundMenuAndCategory);
    }
}
