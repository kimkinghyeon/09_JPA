...
public class OneToManyAssociationTests {
    ...
    public void test1() {
        ...
        //then
        // 출력구문 작성후, 사용하는 경우 연관 테이블을 조회해오는 쿼리가 동작한다.
    ...
    public void test2() {
        ...
        categoryAndMenu.setCategoryCode(887);
        ...
        //then
        CategoryAndMenu foundCategoryAndMenu = entityManager.find(CategoryAndMenu.class,887);
