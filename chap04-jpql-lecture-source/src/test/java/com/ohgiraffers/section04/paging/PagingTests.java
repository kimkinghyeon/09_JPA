...
public class PagingTests {
    ...
    /*
    JPA 는 페이징을 API 를 통해 추상화 하여 간닪라게 처리할 수 있다.
    ...
    * */
    ...
    public void test1() {
        ...
        List<Menu> menuList = entityManager.createQuery(jpql, Menu.class).setFirstResult(offset).setMaxResults(limit).getResultList();
        //then
