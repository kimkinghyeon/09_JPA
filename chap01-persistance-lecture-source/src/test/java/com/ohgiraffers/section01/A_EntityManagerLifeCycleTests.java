...
public class A_EntityManagerLifeCycleTests {
    /*
      ...
      따라서 데이터베이스를 사용하는 애플리케이션 당 한 개의 EntityManagerFactory 를 생성한다.
     * */
    /*
      ...
      따라서 스레드 간 공유를 하지 않고, web 의 경우 일반적으로 request scope 와 일치시킨다.
    ...
    @BeforeAll// 테스트 클래스가 전체가 시작되기 전에 한번만 실행되는 메서드
    ...
    @DisplayName("엔티티 매니저 팩토리와 엔티티 매니저 생명주기 확인.1")
    @Test
    ...
    @DisplayName("엔티티 매니저 팩토리와 엔티티 매니저 생명주기 확인.2")
    @Test
