...
public class PrimaryKeyMappingTests {
    ...
    - strategy : 자동 생성 전략을 지정
        ...
        - GenerationType.AUTO : 자동 선택 (MySQL 이라면 IDENTITY, ORACLE 이라면 SEQUENCE 로 선택)
    - generator : strategy 값을 GenerationType.TABLE 로 지정한 경우 사용되는 테이블 이름을 지정
    - initialValue : strategy 값을 GenerationType.SEQUENCE 로 지정한 경우 시퀀스 초기값을 지정
    ...
    * */
    ...
    public void identityMappingTest() {
        ...
        member1.setPhone("010-2345-6789");
        ...
        member2.setMemberName("동홍길");
        member2.setPhone("020-2345-6789");
        ...
        String jpql = "select a.memberNo from member_section03_sub01 a";
        // entity 명 사용 , 별칭 필수
